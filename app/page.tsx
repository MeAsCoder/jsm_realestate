...
interface PropertyType {
  ...
  baths: number;
  area: number;
  rentFrequency?: string; // Optional, as it may not always be present
  agency?: {
    logo?: {
      url: string;
    };
  };
  isVerified?: boolean; // Optional, as it may not always be present
  externalID?: string; // Optional, as it may not always be present
}
      ...
      <Box>
        ...
        <Flex flexWrap="wrap">
          {propertiesForSale.length ? (
            propertiesForSale.map((property: PropertyType) => <Property property={property} key={property.id} />)
          ):(
  ...
  try {
    ...
    return (
      <Box>
        ...
        <Flex flexWrap="wrap">
          {propertiesForRent.length ? (
            propertiesForRent.map((property: PropertyType) => <Property property={property} key={property.id} />)
          ) : (
            <Text>No properties for rent found</Text>
          )}
        </Flex>
